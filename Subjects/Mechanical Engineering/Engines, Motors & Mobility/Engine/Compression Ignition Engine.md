[📁 Explore](obsidian://open?vault=Saarthak's_Headspace&file=📁%20Explore) > [Mechanical Engineering](obsidian://open?vault=Saarthak's_Headspace&file=Mechanical%20Engineering) > [Engines, Motors & Mobility](obsidian://open?vault=Saarthak's_Headspace&file=Engines,%20Motors%20%26%20Mobility) > [Engine](obsidian://open?vault=Saarthak's_Headspace&file=Engine) > Compression Ignition Engine
